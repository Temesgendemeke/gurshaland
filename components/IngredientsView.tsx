  ...
  return (
    <Card className="p-6 bg-card border border-border rounded-lg">
      <div className="flex items-center justify-between gap-3 border-b border-border pb-3 mb-4">
        <h2 className="heading-secondary text-2xl md:text-3xl">Ingredients</h2>
          ...
          {ingredients.map((ingredient, index) => {
            ...
            return (
              <motion.li
                ...
                className={cn(
                  "group flex items-start gap-3 rounded-lg px-3 py-2.5 transition-colors duration-200 hover:bg-muted/40",
              ...
              >
                <button
                  ...
                  className={cn(
                    "mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-md border transition-all duration-200 active:scale-90",
                    isChecked
                ...
                <div className="relative min-w-0 flex-1">
                  ...
                  {ingredient.notes ? (
                    <p
                      className={cn(
                        "mt-0.5 text-sm text-muted-foreground transition-opacity duration-200",
                  ...
                  <motion.span
                    ...
                    className="absolute left-0 top-[0.95em] h-px w-full origin-left bg-foreground/50"
                  />
                </div>
              </motion.li>
            );

DROP FUNCTION IF EXISTS get_meal_plan_by_id(bigint);
DROP FUNCTION IF EXISTS get_meal_plan_by_id(uuid);

CREATE OR REPLACE FUNCTION get_meal_plan_by_id(_meal_plan_id UUID)
RETURNS JSONB
LANGUAGE plpgsql
AS $$
DECLARE

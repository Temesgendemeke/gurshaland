...
export default function RecipesPage() {
  ...
  const recipes = [
    {
      ...
      description: "Fermented flatbread made from teff flour - the foundation of Ethiopian cuisine",
    ...
    },
    {
      ...
      description: "The soul of Ethiopian cooking - aromatic spice blend with over 15 ingredients",
      image: "/placeholder.svg?height=200&width=300",
      category: "Spices",
      difficulty: "Easy",
      time: "1 hour",
    ...
    },
    {
      ...
      description: "Traditional coffee ceremony - from green beans to the perfect cup",
      image: "/placeholder.svg?height=200&width=300",
      category: "Beverages",
      difficulty: "Medium",
      time: "1 hour",
  ...
  const categories = ["all", "Bread", "Meat", "Vegetarian", "Spices", "Beverages", "Desserts"]
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-body max-w-2xl mx-auto">
            Discover authentic Ethiopian dishes from our community of passionate cooks
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredRecipes.map((recipe) => (
            <Card key={recipe.id} className="modern-card modern-card-hover">
              <div className="relative">
                ...
                <div className="absolute top-4 left-4">
                  <Badge className="bg-white/90 text-gray-700 hover:bg-white">{recipe.category}</Badge>
                </div>
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  <div className="flex flex-wrap gap-1">
                    {recipe.tags.slice(0, 2).map((tag) => (
                      <Badge key={tag} variant="secondary" className="text-xs bg-black/50 text-white hover:bg-black/60">
                        {tag}
                      </Badge>
                    ))}
                  </div>
              ...
              <div className="p-6">
                <h3 className="heading-secondary group-hover:text-emerald-600 dark:group-hover:text-emerald-400">
                  {recipe.title}
                </h3>

...
const ContactLocationForm = ({ form }: { form: UseFormReturn<RestaurantFormType> }) => {
    return (
        <Card className="border-none shadow-lg bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
                          <CardHeader>
                            <div className="flex items-center gap-2 text-primary mb-1">
                              <MapPin className="h-5 w-5" />
                              <span className="font-semibold uppercase tracking-wider text-xs">Location & Contact</span>
                            </div>
